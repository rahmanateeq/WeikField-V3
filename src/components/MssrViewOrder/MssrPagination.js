...
const MssrPagination = (props) => {
  ...
  const onNext = () => {
    ...
    dispatch(selectedMssrPagesNumber(currentPage));
  };
  ...
  const onPrevious = () => {
    ...
    dispatch(selectedMssrPagesNumber(currentPage - 2));
  };
          ...
          <li
            ...
            onClick={() => {
             ...
             console.log('present click',pageNumber)
              dispatch(selectedMssrPagesNumber(pageNumber - 1));
            }}
          >
            {pageNumber}
          </li>
