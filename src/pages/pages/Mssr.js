...
const Mssr = (props) => {
  ...
  const getOrderDetails = async (data) => {
    if (data === "0") {
      ...
      setSalePerson(profile_details.user_name);
      toast.error(
        `You have already filled up MSSR for this month!`
      );
    }
  ...
  const saveOrder = async (e) => {
    ...
    if (
      ...
      await Swal.fire({
        ...
        text: 'Invoice selection is mandatory for calculating SIT stock.\nTick the check box to consider full Primary as SIT, it will reduce DB Secondary.',
        input:'checkbox',
        inputPlaceholder:'I confirm that <b>ENTIRE PRIMARY IS SIT</b> for this DB in this month.',
        showCancelButton: true,
        confirmButtonColor: "#3085d6",
        cancelButtonColor: "#28a745",
        confirmButtonText: "Save Entries",
        ...
        if (result.isConfirmed && result.value===1) {
          ...
          Swal.fire('Invoice selection is mandatory to save Distributor Stock Details');
        }
      });
    } else {
      confirmMssrOrder();
                                ...
                                <div className="row">
                                  <div className="col-md-4">
                                    <label
                                      ...
                                      className="control-label"
                                    >
                                      Check Received Invoices This Month:
                                    </label>
                                  </div>
                                  <div className="col-md-8">
                                    {showInvoice && (
                      ...
                      >
                        <thead>
                          ...
                          <tr>
                            ...
                            <th>Closing <br/>Stock <br/> (in pieces)</th>
                            <th>Last Month <br/>Primary <br/> (in pieces)</th>
                            <th>Last Month <br/>Closing Stock <br/> (in pieces)</th>
                          </tr>
                        </thead>
                        <tbody>
                          {loading ? (
                                    ...
                                    <tr key={index}>
                                      ...
                                      <td className="font12">
                                        <input
                                          ...
                                          step="1"
                                          id={`quantityFieldId1-${item.item_code}`}
                                           placeholder={item.lm_primary_units}
                              ...
                              <div className="cart-prod-desc d-flex mt-2">
                                ...
                                <div className="cart-prod-desc">
                                  <input
                                    ...
                                    placeholder={"LM Pri :" + item.lm_primary_units}
                                    onKeyPress={(event) => {
                                      if (
                                        event.charCode < 48 ||
                                        event.charCode > 58
                                ...
                                <div className="cart-prod-desc">
                                  <input
                                    ...
                                    id={`quantityFieldId-${item.item_code}`}
                                    step="1"
                                    placeholder={"LM CS:"+item.lm_cls_stk}
                                    //placeholder={item.lm_cls_stk}
                                    onKeyPress={(event) => {
                                      if (
                                        event.charCode < 48 ||
