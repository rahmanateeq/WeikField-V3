                      ...
                      >
                        <thead className="MuiTableHead-root">
                          <tr>
                            ...
                            <th>BM Name</th>
                            <th>ZSM Name</th>
                            <th>W/h <br/>Location</th>
                            <th>Block <br/>Sale <br/>Flag</th>
                            <th>MSSR Flag</th>
                            <th>NDC Flag</th>
                            <th>Claim Flag</th>
                            <th>Partner <br/>Type</th>
                            <th>Status</th>
                            <th>BI Channel</th>
                          </tr>
                        </thead>
                          ...
                          {distributorGrid &&
                            distributorGrid.map((data, index) => (
                              <tr key={index}>
                                ...
                                <td className="text-nowrap">{data.price_key}</td>
                                <td className="text-nowrap">{data.price_sub_key}</td>
                                ...
                                <td className="text-nowrap">{ data.block_sale==="YES" ? "Blocked" :"Open" }</td>
                                <td className="text-nowrap">{data.mssr_flag ==="YES" ? "Blocked" :"Open"}</td>
                                <td className="text-nowrap">{data.ndc_flag ==="YES" ? "Blocked" :"Open"}</td>
                                <td className="text-nowrap">{data.claim_flag ==="YES" ? "Blocked" :"Open"}</td>
